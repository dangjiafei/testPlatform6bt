...
from utils.handle_validates import is_existed_project_id, is_existed_interface_id
...
class InterfacesAnotherSerializer(serializers.ModelSerializer):
    ...
    # 项目ID
    pid = serializers.IntegerField(write_only=True, validators=[is_existed_project_id], help_text='项目ID')
    # 接口ID
    iid = serializers.IntegerField(write_only=True, validators=[is_existed_interface_id], help_text='接口ID')
